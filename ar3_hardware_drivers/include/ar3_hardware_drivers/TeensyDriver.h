...
class TeensyDriver {
  ...
  private:
    ...
    int num_joints_;
    std::vector<double> enc_commands_deg_;
    std::vector<double> enc_deg_;
    ...
    void encStepsToJointPos(std::vector<double>& enc_deg, std::vector<double>& joint_positions);
    void jointPosToEncSteps(std::vector<double>& joint_positions, std::vector<double>& enc_deg);
};
